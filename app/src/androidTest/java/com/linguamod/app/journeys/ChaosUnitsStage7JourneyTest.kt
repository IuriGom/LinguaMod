...
/**
 * Stage 7 AC4: chaos-mode pass on units 44, 50 and 60.
 * Same harness as [ChaosUnitsStage6JourneyTest]: the bot answers wrong on
 ...
 * Unit 60 is the course capstone with a 15-exercise checkpoint: chaos mode
 * must still fail and pass it gracefully, and its pass must settle the app
 * into the completed-course home without a crash.
 */
@OptIn(ExperimentalTestApi::class)
@UninstallModules(AppModule::class)
@HiltAndroidTest
@RunWith(AndroidJUnit4::class)
class ChaosUnitsStage7JourneyTest {
    ...
    @Test fun chaos_unit_44() = runChaosUnitJourney(44)
    @Test fun chaos_unit_50() = runChaosUnitJourney(50)
    @Test fun chaos_unit_60() = runChaosUnitJourney(60)
